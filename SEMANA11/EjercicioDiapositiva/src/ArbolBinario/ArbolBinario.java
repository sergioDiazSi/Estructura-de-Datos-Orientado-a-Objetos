...
public class ArbolBinario {
   private Nodo raiz;
    ...
    public void insertar(Empleado valor) {
        raiz = insertar(raiz, valor);
    }

    private Nodo insertar(Nodo r, Empleado valor) {
        if (r == null) {
            r = new Nodo(valor);
        }
    ...
    public Nodo buscar(Nodo r, Empleado valor) {
        if (r != null) {
    ...
    public Nodo buscar(Empleado valor) {
        return buscar(raiz, valor);
    }
    
    public void agregarFila(DefaultTableModel modelo, Empleado x){
        Object fila[] = {x.getCodigo(),x.getNombres(),x.getApellidos(),
            x.getSexo(),x.getSueldo()
        };
        modelo.addRow(fila);
    }
    ...
    public void enOrden(DefaultTableModel modelo){
        String titulos[]={"CODIGO","NOMBRE","APELLIDOS","SEXO","SUELDO"};
    ...
    private Empleado buscarMax(Nodo r){
        Empleado x;
    ...
    private Empleado buscarMin(Nodo r){
        Empleado x;
    ...
    public void elimina(Empleado x){
        raiz = elimina(raiz,x);
    }
    
    private Nodo elimina(Nodo r, Empleado x){
        if(r!=null){
